...
public class SprinklerImportDTO {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SprinklerImportDTO)) return false;
        final SprinklerImportDTO other = (SprinklerImportDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SprinklerImportDTO;
    }
    ...
    public String toString() {
        return "SprinklerImportDTO(shippingDate=" + this.getShippingDate() + ", purchaseDate=" + this.getPurchaseDate() + ", contractNumber=" + this.getContractNumber() + ", headModel=" + this.getHeadModel() + ", headSerial=" + this.getHeadSerial() + ", warehouseDate=" + this.getWarehouseDate() + ", voltage=" + this.getVoltage() + ", jetsout=" + this.getJetsout() + ", status=" + this.getStatus() + ", type=" + this.getType() + ")";
    }
}
