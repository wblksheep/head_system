...
@NoArgsConstructor
@AllArgsConstructor
public class SprinklerMaintainDTO {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SprinklerMaintainDTO)) return false;
        final SprinklerMaintainDTO other = (SprinklerMaintainDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SprinklerMaintainDTO;
    }
